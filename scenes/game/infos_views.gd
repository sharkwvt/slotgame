...
func refresh_level_info_view():
	...
	last_wave_lbl.add_theme_font_size_override("font_size", 40)
	...
	target_cash_lbl.add_theme_font_size_override("font_size", 40)
	...
	bonus_lbl.add_theme_font_size_override("font_size", 40)
